...
from vilbert.datasets import FaceReadingLoaderTrain, FaceReadingLoaderVal
...
def main():
    ...
    train_dataset = FaceReadingLoaderTrain(
        args.file_path,
        tokenizer,
        args.bert_model,
    ...
    validation_dataset = FaceReadingLoaderVal(
        args.file_path,
        tokenizer,
        args.bert_model,
        seq_len=args.max_seq_length,
    ...
    for epochId in range(int(args.start_epoch), int(args.num_train_epochs)):
        ...
        for step, batch in enumerate(train_dataset):
            ...
            input_ids, input_mask, segment_ids, lm_label_ids, is_next, image_feat, image_target, image_label, image_mask = (
                batch
            )
